...
class PaymentStatus {
  ...
  static List<PaymentStatus> getPaymentStatusList() {
    return <PaymentStatus>[
      PaymentStatus('', 'All'.tr()),
      PaymentStatus('paid', 'Paid'.tr()),
      PaymentStatus('unpaid', 'Unpaid'.tr()),
    ];
  }
}
...
class DeliveryStatus {
  ...
  static List<DeliveryStatus> getDeliveryStatusList() {
    return <DeliveryStatus>[
      DeliveryStatus('', 'All'.tr()),
      DeliveryStatus('confirmed'.tr(), 'Confirmed'.tr()),
      DeliveryStatus('on_delivery', 'On Delivery'.tr()),
      DeliveryStatus('delivered', 'Delivered'.tr()),
    ];
  }
}
