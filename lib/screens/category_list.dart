...
class _CategoryListState extends State<CategoryList> {
  ...
  String getAppBarTitle() {
    String name = widget.parent_category_name == ""
        ? (widget.is_top_category ? "Top Categories".tr() : "Categories".tr())
                      ...
                      onTap: () {
                        if (categoryResponse
                          ...
                          ToastComponent.showDialog(
                              "No sub categories available".tr(), context,
                              gravity: Toast.CENTER,
                              duration: Toast.LENGTH_LONG);
                        }
                      },
                      child: Text(
                        "View Sub-Categories".tr(),
                        textAlign: TextAlign.left,
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1,
                        style: TextStyle(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: FlatButton(
                  ...
                  child: Text(
                    "All Products of ".tr() + widget.parent_category_name,
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 13,
                        fontWeight: FontWeight.w600),
