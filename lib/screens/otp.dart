...
class _OtpState extends State<Otp> {
  ...
  onPressConfirm() async {
    ...
    if(code == ""){
      ToastComponent.showDialog("Enter verification code".tr(), context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }
                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      child: _verify_by == "email"
                          ? Text(
                              "Enter the verification code that sent to your email recently.".tr(),
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  color: MyTheme.dark_grey, fontSize: 14))
                          : Text(
                              "Enter the verification code that sent to your phone recently.".tr(),
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  color: MyTheme.dark_grey, fontSize: 14))),
                ),
