...
class _PaystackScreenState extends State<PaystackScreen> {
  ...
  onPaymentSuccess(payment_details) async{
    ...
    var paystackPaymentSuccessResponse = await PaymentRepository().getPaystackPaymentSuccessResponse(widget.payment_type, widget.amount,_order_id, payment_details);
  ...
  buildBody() {
    ...
    String initial_url =
        "${AppConfig.BASE_URL}/paystack/init?payment_type=${widget.payment_type}&order_id=${_order_id}&amount=${widget.amount}&user_id=${user_id.value}";
