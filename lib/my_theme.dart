...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(213, 43, 30, 1.0);
  static Color soft_accent_color = Color.fromRGBO(247,189,168, 1);
  static Color splash_screen_color = Color.fromRGBO(213, 43, 30, 1.0); // if not sure , use the same color as accent color
